...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-08-06T09:45:40.037357600+09:00[GMT+09:00]", comments = "Generator version: 7.5.0")
public class TasksDto {
   ...
   */
  public TasksDto(Integer id, String title, StatusEnum status) {
    this.id = id;
    this.title = title;
    this.status = status;
  }

  public TasksDto id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public TasksDto title(String title) {
    this.title = title;
    return this;
  }
  ...
  */
  ...
  public TasksDto description(String description) {
  ...
  */
  ...
  public TasksDto status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  */
  ...
  public TasksDto dueDate(LocalDate dueDate) {
